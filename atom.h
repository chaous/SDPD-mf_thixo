...
class Atom : protected Pointers {
 public:
  ...
  double **vest;
    ...
    //USER-SPH-PI with stress micro // Modified by NMC
    double **stmic;
    double **stfluid;
    double **gradv;
    double *gammadot;
  ...
  int mesont_flag;
    ...
    int stmic_flag, stfluid_flag, gradv_flag, gammadot_flag, fintx_flag, finty_flag; //Modified by NMC for Pi atom type.
    int cc_flag, cc_flux_flag;
