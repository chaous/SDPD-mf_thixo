...
void Atom::peratom_create()
{
  ...
  //Modified by NMC for SPH-PI with micro stress
  add_peratom("stfluid",&stfluid,DOUBLE,6);
  add_peratom("stmic",&stmic,DOUBLE,6);
  add_peratom("gradv",&gradv,DOUBLE,9);
  add_peratom("gammadot",&gammadot,DOUBLE,0);
  add_peratom("fintx",&fintx,DOUBLE,0);
  add_peratom("finty",&finty,DOUBLE,0);
...
void Atom::set_atomflag_defaults()
{
  ...
  //Modified by NMC
  stfluid_flag = stmic_flag = gradv_flag = gammadot_flag = fintx_flag= finty_flag=0;
  cc_flag =cc_flux_flag = 0;
...
void *Atom::extract(const char *name)
{
  ...
  if (strcmp(name,"stmic") == 0) return (void *) stmic; //Modified by NMC 
  if (strcmp(name,"stfluid") == 0) return (void *) stfluid; //Modified by NMC 
  if (strcmp(name,"gradv") == 0) return (void *) gradv; //Modified by NMC
  if (strcmp(name,"gammadot") == 0) return (void *) gammadot; //Modified by ASE  
  if (strcmp(name,"fintx") == 0) return (void *) fintx; //Modified by ASE  
  if (strcmp(name,"finty") == 0) return (void *) finty; //Modified by ASE  

  if (strcmp(name,"cc") == 0) return (void *) cc; //Modified by NMC 
  if (strcmp(name,"cc_flux") == 0) return (void *) cc_flux; //Modified by NMC 
...
int Atom::extract_datatype(const char *name)
{
  ...
  if (strcmp(name,"stmic") == 0) return LAMMPS_DOUBLE_2D; //Modified by NMC 
  if (strcmp(name,"stfluid") == 0) return LAMMPS_DOUBLE_2D; //Modified by NMC 
  if (strcmp(name,"gradv") == 0) return LAMMPS_DOUBLE_2D; //Modified by NMC 
  if (strcmp(name,"gammadot") == 0) return LAMMPS_DOUBLE_2D; //Modified by NMC   
  if (strcmp(name,"fintx") == 0) return LAMMPS_DOUBLE;  //Modified by ASE for sdpdc
  if (strcmp(name,"finty") == 0) return LAMMPS_DOUBLE;  //Modified by ASE for sdpdc

  if (strcmp(name,"cc") == 0) return LAMMPS_DOUBLE_2D; //Modified by NMC for sdpdc 
  if (strcmp(name,"cc_flux") == 0) return LAMMPS_DOUBLE_2D; //Modified by NMC for sdpdc
